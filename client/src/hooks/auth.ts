...
import {Register, AuthOpts, Login, Logout, ForgotPassword, ResetPassword, ResendEmailVerification} from "@/lib/types/Auth";
...
export const useAuth = ({middleware, redirectIfAuthenticated}: AuthOpts = {}) => {
    ...
    const login = async ({setErrors, setStatus, ...props}: Login) => {
        await csrf()
