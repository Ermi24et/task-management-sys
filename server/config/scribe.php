...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'A token will be set before each request. You can also retrieve the token by opening <b>Dev Tools->Application Tab->Cookies</b> and copy the <em>task_manager</em> cookie value and paste it in the Auth section .',
    ],
